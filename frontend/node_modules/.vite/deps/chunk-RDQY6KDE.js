  ...
  async query(options = {}, messageSetToAddToIfDoesNotExist = "current") {
    ...
    messageSet.pagination = {
      ...
      ...messageSetPagination({
        ...
        requestedPageSize: ((_f = options == null ? void 0 : options.messages) == null ? void 0 : _f.limit) ?? DEFAULT_QUERY_CHANNEL_MESSAGE_LIST_PAGE_SIZE,
  ...
  _handleChannelEvent(event) {
    ...
    switch (event.type) {
      ...
      case "channel.hidden":
        channel.data = {
          ...channel.data,
          blocked: !!((_x = event.channel) == null ? void 0 : _x.blocked),
          hidden: true
        };
      ...
      case "channel.visible":
        channel.data = {
          ...channel.data,
          blocked: !!((_y = event.channel) == null ? void 0 : _y.blocked),
          hidden: false
        };
        (_z = this.getClient().offlineDb) == null ? void 0 : _z.handleChannelVisibilityEvent({ event });
        break;
      case "user.banned":
        ...
        break;
      case "user.unbanned":
        if (!((_C = event.user) == null ? void 0 : _C.id)) break;
        channelState.members[event.user.id] = {
          ...channelState.members[event.user.id] || {},
          shadow_banned: false,
          banned: false,
          user: { ...((_D = channelState.members[event.user.id]) == null ? void 0 : _D.user) || {}, ...event.user }
        };
        break;
      default:
    }
...
//# sourceMappingURL=chunk-RDQY6KDE.js.map

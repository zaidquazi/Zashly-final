...
export declare function createTexture(gl: WebGL2RenderingContext, internalformat: number, width: number, height: number, minFilter?: 9728, magFilter?: 9728): WebGLTexture | null;
